...
const AddWorkshop = () => {
    ...
    const AddWorkshopPermissions = permissions['Workshop'];
    ...
    const onSubmit = async (formData, event) => {
        ...
        const workshopData = {
            ...formData,
            spot: formData.spot ? "1" : "0"
        };

        try {
            console.log('Form data to send:', workshopData);
            const token = getToken();
            await axios.post(`${BackendAPI}/workshop/addworkshop`, workshopData, {
                headers: {
                    Authorization: `Bearer ${token}` // Include the token in the Authorization header
                }
            });
                                            ...
                                            <Row>
                                                ...
                                                <Col md="4" className="mb-3">
                                                    <div>
                                                        ...
                                                        >
                                                            <PopoverHeader>Workshop Icon Preview</PopoverHeader>
                                                            <PopoverBody>
                                                                {iconPreviewUrl ? (
