...
const Workshoptype = () => {
        ...
        try {
            ...
            SweetAlert.fire({
                ...
                if (result.dismiss === SweetAlert.DismissReason.timer) {
                    navigate(`${process.env.PUBLIC_URL}/onsite/manage-workshoptype/Consoft`);
                }
            });
    ...
    const WorkshopsPermissions = permissions['Workshoptype'];
    ...
    const fetchWorkshop = async () => {
        try {
            ...
            //     }
            // });
            const Response = await axios.get(`${BackendAPI}/workshop/getWorkshoptype`, {
                params: {
                    page: currentPage,
                    pageSize: pageSize,
                    search: searchText,
    ...
    const handleEdit = (workshopId, workshopname) => {
        const URL = '/onsite/edit-Workshoptype/';
    ...
    const handleDelete = async () => {
        try {
            ...
            const token = getToken();
            await axios.delete(`${BackendAPI}/workshop/deleteworkshoptype`, {
                headers: {
                    Authorization: `Bearer ${token}` // Include the token in the Authorization header
                },
    ...
    const handleStatusUpdate = async () => {
        ...
        try {
            const token = getToken();
            await axios.put(`${BackendAPI}/workshop/UpdateworkshoptypeStatus`, { workshopId, status: newStatus, Name: currentWorkshop.cs_workshop_name }, {
                headers: {
                    Authorization: `Bearer ${token}` // Include the token in the Authorization header
                }
            });
    ...
    const handleNavigation = () => {
        navigate(`${process.env.PUBLIC_URL}/onsite/add-workshoptype/Consoft`);
    };
