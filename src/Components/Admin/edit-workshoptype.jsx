...
const EditWorkshopType = () => {
    ...
    const fetchWorkshop = async () => {
        try {
            ...
            const response = await axios.post(`${BackendAPI}/workshop/editworkshoptype`, { workshopId }, {
                headers: {
    ...
    const onSubmit = async (values) => {
        ...
        try {
            ...
            const response = await axios.post(`${BackendAPI}/workshop/updateworkshoptype`, { values, workshopId }, {
                headers: {
                    Authorization: `Bearer ${token}` // Include the token in the Authorization header
                }
            });
            ...
            SweetAlert.fire({
                ...
                if (result.dismiss === SweetAlert.DismissReason.timer) {
                    navigate(`${process.env.PUBLIC_URL}/onsite/manage-workshoptype/${layoutURL}`);
                }
            });
        } catch (error) {
...
export default EditWorkshopType;
