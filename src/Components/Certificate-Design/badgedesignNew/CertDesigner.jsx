...
import CertificateElement from '../badgelement/CertificateElement';
import ComponentSettings from '../componentsetting/ComponentSettings';
import './CertDesigner.css';
...
import { Card, Col, ButtonGroup, Row } from 'reactstrap';
...
const CertDesigner = () => {
    ...
    const [badgeName1, setBadgeName] = useState(storedData.badgeName);
    ...
    const [zoom, setZoom] = useState(0.60); // Default zoom level
    ...
    console.log("dfdfdfdfdfd : ", badgeType);
    ...
    const saveBadgeDesign = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${BackendAPI}/certificate/saveCertDesign`, badgeDesign, {
                headers: {
            ...
            if (response.status === 200 || response.status === 201) {
                ...
                console.error('Failed to save certificate design. Unexpected response:', response);
                toast.error('Failed to save certificate design. Please try again.');
            }
        } catch (error) {
            console.error('Error saving certificate design:', error);
            alert('Failed to save certificate design. Please try again.');
        }
    };
    ...
    const addFieldAsComponent = (field, side = 'front') => {
        const newComponent = {
            id: uuidv4(),
            ...
            textFontSize: 12,
            side: side, // Assign side here ('front' or 'back')
        };
    ...
    const addComponentImage = async (imageFile) => {
        ...
        try {
            ...
            const response = await axios({
                method: 'post',
                url: `${BackendAPI}/certificate/uplaodebadgeimg`,
                data: formData,
                headers: {
            ...
            <Card>
                <div className='certificate-wrapper'>
                    ...
                    <div className="zoom-controls">
                        <ButtonGroup>
                            <Button outline onClick={zoomOut} disabled={zoom <= 0.5} className="zoom-button">
                                <FaSearchMinus /> 
                            </Button>
                            <Button outline onClick={resetZoom} disabled={zoom === 1} className="zoom-button">
                                <FaRedo />
                            </Button>
                            <Button outline onClick={zoomIn} disabled={zoom >= 2} className="zoom-button">
                                <FaSearchPlus /> 
                            </Button>
                        </ButtonGroup>
                    </div>
                    ...
                    <div className="badge-designer-container">
                            ...
                            <Card >
                                ...
                                <CardHeader>
                                    ...
                                    <div className="badge-section">
                                        <label className="d-flex justify-content-between align-items-center mb-2">
                                            <strong>Certificate Section</strong>
                        ...
                        <Col md="7" className='container-col-wrap'>
                            ...
                            <div className="designer-container">
                                <div
                                    className={`certificate-container ${showGrid ? 'grid-active' : ''} ${rotateBadge ? 'rotate-180' : ''}`}
                                    style={{
                                        ...badgeContainerStyle,
                                        backgroundColor: showGrid ? '#f0f0f0' : 'transparent',
                                        border: rotateBadge ? '2px dashed #000' : '1px solid #ccc',
                                ...
                                <Card>
                                    <CardBody>
                                        <div className="d-flex flex-column align-items-start">
                                            ...
                                            {/* Save Button */}
                                            <button className="save-button" onClick={saveBadgeDesign}><IoSaveOutline /></button>
                                        </div>
                                    </CardBody>
                                </Card>
