...
const ManageRegFaculty = () => {
    ...
    const ManageRegFacultyPermissions = permissions['ManageRegFaculty'];
    ...
    return (
        <Fragment>
            ...
            } parent="Registration Admin" title="Manage Faculty" />
...
export default ManageRegFaculty;
