...
const LatestRegUsers = () => {
    ...
    const fetchLatestBasicUsers = async () => {
        try {
            ...
            const response = await axios.get(`${BackendAPI}/regWidgets/latestRegUsers`, {
                headers: {
            ...
            <Container fluid={true}>
                <Row>
                    <Col sm="12">
                        <Card>
                            <CardHeader>
                                <h5 className="mb-2 text-start">Latest Registered Users</h5>
                            </CardHeader>
                            <CardBody>
                                {loading ? (
                                    <p>Loading...</p>
