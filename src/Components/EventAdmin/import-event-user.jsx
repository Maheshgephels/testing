...
const ImportEventUser = () => {
    ...
    const ImportEventUserPermissions = permissions['ImportEventUser'];
        ...
        try {
            ...
            if (result.isConfirmed) {
                ...
                const sendChunk = async (chunk) => {
                    try {
                        await axios.post(`${BackendAPI}/eventuser/addBulkUser`, {
    ...
    const handleDownloadSampleFile = async () => {
        try {
            ...
            const response = await axios.get(`${BackendAPI}/eventuser/samplefile`, {
    ...
    const handleDownloadInstructionFile = async () => {
        try {
            // Make a GET request to the sample file route
            console.log("hello");
            const response = await axios.get(`${BackendAPI}/eventuser/instructionfile`, {
                responseType: 'blob' // Specify responseType as 'blob' to handle binary data
            });
                    ...
                    <Col sm="12">
                        <Card>
                            <CardHeader className="d-flex justify-content-between align-items-center flex-column flex-md-row">
                                ...
                                {ImportEventUserPermissions?.add === 1 && (
...
export default ImportEventUser;
