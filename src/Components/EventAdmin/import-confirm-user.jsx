...
const ImportConfirmUser = () => {
    ...
    const ImportConfirmUserPermissions = permissions['ImportConfirmUserwithregno'];
        ...
        try {
            ...
            if (result.isConfirmed) {
                ...
                const sendChunk = async (chunk) => {
                    try {
                        await axios.post(`${BackendAPI}/eventuser/addBulkConfirmUser`, {
    ...
    const handleDownloadSampleFile = async () => {
        try {
            ...
            console.log("hello");
            const response = await axios.get(`${BackendAPI}/eventuser/Confirmsamplefilewithregno`, {
    ...
    const handleDownloadInstructionFile = async () => {
        try {
            // Make a GET request to the sample file route
            console.log("hello");
            const response = await axios.get(`${BackendAPI}/eventuser/ConfirmInstructionfilewithregno`, {
                responseType: 'blob' // Specify responseType as 'blob' to handle binary data
            });
...
export default ImportConfirmUser;
