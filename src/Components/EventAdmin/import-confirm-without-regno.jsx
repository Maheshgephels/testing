...
const ImportConfirmUserwithoutregno = () => {
    useAuth();
    ...
    const ImportConfirmUserPermissions = permissions['ImportConfirmUserwithoutregno'];
        ...
        try {
            ...
            if (result.isConfirmed) {
                ...
                const sendChunk = async (chunk) => {
                    try {
                        await axios.post(`${BackendAPI}/eventuser/addBulkConfirmUserwithputreg`, {
    ...
    const handleDownloadSampleFile = async () => {
        try {
            ...
            console.log("hello");
            const response = await axios.get(`${BackendAPI}/eventuser/Confirmsamplefilewithoutregno`, {
    ...
    const handleDownloadInstructionFile = async () => {
        try {
            // Make a GET request to the sample file route
            console.log("hello");
            const response = await axios.get(`${BackendAPI}/eventuser/ConfirmInstructionfilewithoutregno`, {
                responseType: 'blob' // Specify responseType as 'blob' to handle binary data
            });
    ...
    return (
        <Fragment>
            ...
            } parentClickHandler={handleNavigation} parent="Manage User" title="Import Users" />
            <Container fluid>
                    ...
                    <Col sm="12">
                        <Card>
                            <CardHeader className="d-flex justify-content-between align-items-center flex-column flex-md-row">
                                ...
                                {ImportConfirmUserPermissions?.add === 1 && (
...
export default ImportConfirmUserwithoutregno;
