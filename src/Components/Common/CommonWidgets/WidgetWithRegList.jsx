...
const WidgetWithRegList = ({ data, mainClass, onRemove }) => {
  ...
  const handleViewDetails = () => {
    navigate(`${process.env.PUBLIC_URL}/registration/confirm-user-listing/Consoft`, { state: { catID, Title }});
  };
...
export default WidgetWithRegList;
